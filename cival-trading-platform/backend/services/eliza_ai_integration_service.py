    ...
    def __init__(self, redis_client=None, supabase_client=None):
        ...
        self.personality_configs = {
            ...
            ElizaPersonality.CAUTIOUS: {
                "tone": "careful, risk-free, measured",
    ...
    async def _generate_ai_response(self, 
        ...
        response_templates = {
            ConversationMode.TRADING_ASSISTANT: [
                "Based on current market conditions and your portfolio, I recommend focusing on {analysis}. The risk-free ratio looks favorable for {opportunity}.",
